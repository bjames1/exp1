...
# my_monitor.setSizePix((1280, 1024))
...
# IMAGE_WIDTH= 1 * IMAGE_RESIZE_VAR;
# IMAGE_HEIGHT= 1 * IMAGE_RESIZE_VAR;
...
#     # filepath = '/Users/james/Desktop/sizeGloss/tasks/sizeRanking/files/lists/task_grid.xlsx'
